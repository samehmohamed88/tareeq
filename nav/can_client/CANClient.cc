//#include "nav/can_client/can_client.h"
//
//#include "nav/can_client/usb_can_adapter.h"
//
//#include <unistd.h>
//#include <cassert>
//#include <stdexcept>
...
//
//CANClient::CANClient() :
//    usb_adapter_{std::make_unique<UsbCANAdapter>()}
//    , bus_offset(0)
//{
//    device_reset();
//}
//
//void CANClient::device_reset() {
//    // taken from https://github.com/commaai/openpilot/blob/master/selfdrive/boardd/panda.cc#L270
//    usb_adapter_->control_write(DeviceRequests::ResetCommunications, 0, 0);
//}
//
//bool CANClient::is_connected() const {
//    return usb_adapter_->is_connected();
//}
//
//bool CANClient::is_comm_healthy() const {
//    return usb_adapter_->is_comm_health();
//}
//
//void CANClient::set_safety_model(SafetyModel safety_model, uint16_t safety_param) {
//    usb_adapter_->control_write(DeviceRequests::SafetyModel, (uint16_t)safety_model, safety_param);
//}
//
//void CANClient::set_alternative_experience(uint16_t alternative_experience) {
//    usb_adapter_->control_write(0xdf, alternative_experience, 0);
//}
//
//int CANClient::get_comma_ai_device_name() {
//    unsigned char hw_query[1] = {0};
//
//    usb_adapter_->control_read(DeviceRequests::CommaAIDeviceName, 0, 0, hw_query, 1);
//    return hw_query[0];
//
//}
//
...
//    for (auto fn : { "can_client.bin.signed", "panda_h7.bin.signed" }) {
//      auto content = util::read_file(std::string("../../can_client/board/obj/") + fn);
...
//    // check if the message is intended for this can_client
