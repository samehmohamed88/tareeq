...
class TestBoardd(unittest.TestCase):
  ...
  def test_loopback(self):
    ...
    self.assertEqual(num_pandas, expected_pandas, "connected pandas ({num_pandas}) doesn't match expected can_client count ({expected_pandas}). \
                                                   connect another can_client for multipanda tests.")
