...
int main(int argc, const char *argv[]) {
    try {
        ...
        // Get a random vehicles blueprint.
        auto blueprint_library = world.GetBlueprintLibrary();
        auto vehicles = blueprint_library->Filter("vehicles");
        ...
        // Move spectator so we can see the vehicles from the simulator window.
        ...
        /*
            ...
            // Spawn a camera attached to the vehicles.
