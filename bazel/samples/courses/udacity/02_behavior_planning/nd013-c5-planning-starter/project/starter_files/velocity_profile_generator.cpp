...
velocity profile for each of the states that the vehicles can be in.
...
std::vector<TrajectoryPoint> VelocityProfileGenerator::generate_trajectory(
  ...
  // If we need to follow the lead vehicles, make sure we decelerate to its speed
...
// Computes a velocity trajectory for following a lead vehicles
