...
def config_cuda_toolkit_and_nvcc(repository_ctx, cuda):
    ...
    if cuda.path != None:
        ...
        repository_ctx.symlink(Label("//cuda:runtime/BUILD.bazel.local_cuda"), "BUILD.bazel")
    ...
    tpl_label = Label(
        "//cuda:templates/BUILD.bazel.local_toolchain_" +
...
def config_clang(repository_ctx, cuda, clang_path):
    ...
    """
    tpl_label = Label("//cuda:templates/BUILD.bazel.local_toolchain_clang")
    substitutions = {
