...
struct IMUData {
    ...
    IMUData(double temp, double roll, double pitch, double yaw,
            double acceleration_X, double acceleration_Y, double acceleration_Z,
            double gyro_X, double gyro_Y, double gyro_Z,
            double magnetometer_X, double magnetometer_Y, double magnetometer_Z)
        : temp(temp), roll(roll), pitch(pitch), yaw(yaw),
        acceleration_X(acceleration_X), acceleration_Y(acceleration_Y), acceleration_Z(acceleration_Z),
        gyro_X(gyro_X), gyro_Y(gyro_Y), gyro_Z(gyro_Z),
        magnetometer_X(magnetometer_X), magnetometer_Y(magnetometer_Y), magnetometer_Z(magnetometer_Z) {};
};
