...
class TestBoardd(unittest.TestCase):
  ...
  def test_loopback(self):
    ...
    self.assertEqual(num_pandas, expected_pandas, "connected pandas ({num_pandas}) doesn't match expected can count ({expected_pandas}). \
                                                   connect another can for multipanda tests.")
