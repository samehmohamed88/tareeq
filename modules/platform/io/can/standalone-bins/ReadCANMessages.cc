...
#include "can_client/CommaAICANInterfaceWithBoostBuffer.h"
...
//
//    std::string filename = "/apollo/nav/can/data/can_output_2023-11-25_22-32-26.bin"; // Replace with your filename
//    std::ifstream file(filename, std::ios::binary);
//    const size_t chunkSize = 1024; // Size of each chunk in bytes
//    std::vector<uint8_t> buffer(chunkSize);
//
//    std::ofstream parsedData("/apollo/nav/can/data/can_parsed_2023-11-27_09-32-26.csv");
//
//
